...
app.get("/shoes", (req, res) => {
  ...
  const minPrice = Number(req.query["min-price"]) || 0; //to retrieve min-price, need to use [] instead of dot notation because of the hyphen
  const maxPrice = Number(req.query["max-price"]) || Infinity;
